...
Keyboard::Keyboard()
{
    ...
    if (!keyTexture.loadFromFile(KeyImageFile)) std::cerr << "Unable to load " << KeyImageFile << std::endl;
    if (!enterTexture.loadFromFile(EnterImageFile)) std::cerr << "Unable to load " << EnterImageFile << std::endl;
    if (!backspaceTexture.loadFromFile(BackspaceImageFile)) std::cerr << "Unable to load " << BackspaceImageFile << std::endl;
