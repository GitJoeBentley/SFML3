...
const std::string WordFile = ResourcePath + "wordfile4.bin";
...
const std::string DohSoundFile = ResourcePath + "homer_doh.wav";
...
const std::string Title= "FOUR LETTER WORDLE";
...
const sf::Vector2u GameSizeU(720u, 768u);
...
const sf::Color GreenColor =  sf::Color(90,200,50);
const sf::Color YellowColor = sf::Color(220,210,70);
const sf::Color GreyColor =   sf::Color(128,128,128);
const sf::Color LightGreyColor = sf::Color(210,210,210);
const sf::Color LightYellowColor = sf::Color(240,240,200);
