...
const std::string WordFile = ResourcePath + "wordfile6.bin";
...
const std::string LoseSoundFile = ResourcePath + "lose.wav";
const std::string Fifth = ResourcePath + "fifth.ogg";
const std::string Title= "SIX LETTER WORDLE";
